...
class PuzzleThreeScreen extends StatefulWidget {
  @override
  _PuzzleThreeScreenState createState() => _PuzzleThreeScreenState();
}

class _PuzzleThreeScreenState extends State<PuzzleThreeScreen> {
    ...
    return Scaffold(
      body: Stack(
        children: [
                    ...
                    builder: (context, candidateData, rejectedData) {
                      return Container(
                        ...
                        child: placedPieces[pieceKey] == true
                            ? Image.asset(
                                "assets/puzzle/art3/pz3-row-${index ~/ 3 + 1}-column-${index % 3 + 1}.png",
                                fit: BoxFit.cover,
                              )
                            : null,
                      );
          ...
          // Scattered Puzzle Pieces (Adjusted for Level 3)
          for (int i = 0; i < 9; i++)
            Positioned(
              ...
              child: Draggable<String>( 
                ...
                child: placedPieces['pz$i'] == true
                    ? SizedBox.shrink()
                    : Image.asset(
                        "assets/puzzle/art3/pz3-row-${i ~/ 3 + 1}-column-${i % 3 + 1}.png",
                        width: 75,
                        height: 50,
                      ),
              ...
              child: Center(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => DialogueScreen3()), // Updated dialogue screen
                    );
                  },
